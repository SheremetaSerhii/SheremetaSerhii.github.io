...
var
    ...
    circlesCounter = 0,
    finishSquaresList = [],
    gameElements = document.getElementsByTagName("section");
...
for (var i = 0; i < gameElements.length; i++) {
    gameElements[i].addEventListener("dragenter", function () {
        goToMainScreen("lose");
    }, false);
    gameElements[i].addEventListener("mousemove", function (e) {
        e.stopPropagation();
    }, false);
    gameElements[i].addEventListener("mouseenter", function (e) {
